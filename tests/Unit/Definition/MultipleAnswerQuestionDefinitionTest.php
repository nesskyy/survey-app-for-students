...
class MultipleAnswerQuestionDefinitionTest extends TestCase
{
    /** @test */
    ...
    public function it_fails_if_question_has_less_than_three_characters(): void
    {
        ...
        new MultipleAnswerQuestionDefinition('12', new AnswerDefinition('answer_one', true, 1));
    }
    ...
    public function it_has_answer_definitions(): void
    {
        ...
        $questionDefinition = new MultipleAnswerQuestionDefinition(
            'some_question',
            $answerDefinition1,
            $answerDefinition2
        );
    ...
    /** @test */
    public function it_fails_if_does_not_have_at_least_one_correct_answer_definition(): void
    {
        $this->expectException(\InvalidArgumentException::class);

        new MultipleAnswerQuestionDefinition(
            'some_question',
            new AnswerDefinition('answer_one', false, -1),
            new AnswerDefinition('answer_two', false, -1),
